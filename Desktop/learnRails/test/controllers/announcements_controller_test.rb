...
class AnnouncementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create announcement" do
    assert_difference('Announcement.count') do
      post announcements_url, params: { announcement: { ends_at: @announcement.ends_at, message: @announcement.message, starts_at: @announcement.starts_at } }
    end
  ...
  test "should update announcement" do
    patch announcement_url(@announcement), params: { announcement: { ends_at: @announcement.ends_at, message: @announcement.message, starts_at: @announcement.starts_at } }
